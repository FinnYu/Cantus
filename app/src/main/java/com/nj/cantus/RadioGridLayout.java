...
public class RadioGridLayout extends GridLayout
{
	...
	public void onInitializeAccessibilityEvent(@NonNull AccessibilityEvent event) {
		...
		event.setClassName(RadioGridLayout.class.getName());
	}

	@Override
	public void onInitializeAccessibilityNodeInfo(@NonNull AccessibilityNodeInfo info) {
		super.onInitializeAccessibilityNodeInfo(info);
		info.setClassName(RadioGridLayout.class.getName());
	}

	public interface OnCheckedChangeListener {
		void onCheckedChanged(RadioGridLayout group, int checkedId);
	}
	...
	private class PassThroughHierarchyChangeListener implements
		...
		public void onChildViewAdded(View parent, View child) {
			if (parent == RadioGridLayout.this && child instanceof AppCompatRadioButton) {
				int id = child.getId();
